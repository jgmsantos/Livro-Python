...
ax.set_title('Climatologia de Temperatura')

# Formatação do eixo x:
ax.set_xlabel('Meses', fontsize=10)  # Título do eixo x e o seu tamanho.
plt.xticks(fontsize=10)  # Tamanho dos rótulos do eixo x.

# Formatação do eixo y:
ax.set_ylabel('Temperatura (ºC)', fontsize=10)  # Título do eixo y e o seu tamanho.
