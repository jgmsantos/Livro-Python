...
# Fecha qualquer ambiente gráfico para evitar erro na geração do próximo gráfico.
plot.close('all')
...
# Salva a figura no formato ".jpg" com dpi=300 e remove espaços excedentes.
fig1.savefig('ex06.jpg', transparent=True, dpi=300, bbox_inches='tight', pad_inches=0)