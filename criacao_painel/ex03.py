...
ax1.set_xlabel('Mês', fontsize=14)  # Título do eixo x e o seu tamanho.
ax2.set_xlabel('Mês', fontsize=14)  # Título do eixo x e o seu tamanho.
ax3.set_xlabel('Mês', fontsize=14)  # Título do eixo x e o seu tamanho.
ax4.set_xlabel('Mês', fontsize=14)  # Título do eixo x e o seu tamanho.
...
ax1.set_ylabel('Temperatura (ºC)', fontsize=14)  # Título do eixo y e o seu tamanho.
ax2.set_ylabel('Temperatura (ºC)', fontsize=14)  # Título do eixo y e o seu tamanho.
ax3.set_ylabel('Precipitação (mm/mês)', fontsize=14)  # Título do eixo y e o seu tamanho.
ax4.set_ylabel('Precipitação (mm/mês)', fontsize=14)  # Título do eixo y e o seu tamanho.
