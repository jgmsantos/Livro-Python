...
vetor = ax.quiver(lon, lat, u, v, vel, headwidth=6, headlength=6, 
...
#  Barra de cores.
fig.colorbar(vetor, loc='r', shrink=0.95, label='Velocidade (m/s)',
...
plt.savefig('x03.jpg', transparent=True, dpi=300, bbox_inches='tight', pad_inches=0.1)