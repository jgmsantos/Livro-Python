...
x = df['Prec']  # Importa os valores de precipitação.
...
plt.title('Histograma de Precipitação: 2003-2020', fontsize=8)

# Formatação do eixo x.
plt.xlabel('Classes (mm/mês)', fontsize=8)  # Título do eixo x e o tamanho da fonte.
