...
# Destaca o maior valor da série que é o terceiro valor do arquivo classificacao_vento.txt.
explode = (0, 0, 0.1)
...
plt.title("Categorias de velocidade do vento", y=1.05, fontsize=15)
