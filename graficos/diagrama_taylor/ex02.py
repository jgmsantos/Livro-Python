...
# {'ccoef': array([1.        , 0.82997571]), 
# 'crmsd': [0.0, 47.498368220553665], 
# 'sdev': [54.80676311679932, 81.84068894654936]}
...
# Desvio padrão.
sdev = np.array([taylor_stats1['sdev'][0], taylor_stats1['sdev'][1], taylor_stats2['sdev'][1], 
                 taylor_stats3['sdev'][1], taylor_stats4['sdev'][1], taylor_stats5['sdev'][1], 
                 taylor_stats6['sdev'][1], taylor_stats7['sdev'][1], taylor_stats8['sdev'][1], 
                 taylor_stats9['sdev'][1], taylor_stats10['sdev'][1]])

# RMSD.
crmsd = np.array([taylor_stats1['crmsd'][0], taylor_stats1['crmsd'][1], taylor_stats2['crmsd'][1], 
                  taylor_stats3['crmsd'][1], taylor_stats4['crmsd'][1], taylor_stats5['crmsd'][1], 
                  taylor_stats6['crmsd'][1], taylor_stats7['crmsd'][1], taylor_stats8['crmsd'][1], 
                  taylor_stats9['crmsd'][1], taylor_stats10['crmsd'][1]])

# Correlação.
ccoef = np.array([taylor_stats1['ccoef'][0], taylor_stats1['ccoef'][1], taylor_stats2['ccoef'][1], 
                   taylor_stats3['ccoef'][1], taylor_stats4['ccoef'][1], taylor_stats5['ccoef'][1], 
                   taylor_stats6['ccoef'][1], taylor_stats7['ccoef'][1], taylor_stats8['ccoef'][1], 
                   taylor_stats9['ccoef'][1], taylor_stats10['ccoef'][1]])
...
label2 = ['M1: ACCESS1-0','M2: BCC-CSM1.1','M3: BESM','M4: CANESM',
         'M5: CCSM4','M6: CNRM-CM5','M7: CSIRO-MK3-6-0','M8: FGOALS-G2',
         'M9: GFDL-CM3', 'M10: GFDL-ESM2G']
...
sm.taylor_diagram(sdev, crmsd, ccoef,
                  styleOBS='-', colOBS='black', markerobs='o', titleOBS='Observação', 
                  markerLabel=label1, markerSize=9, markerColor='red', axismax=100.0,
