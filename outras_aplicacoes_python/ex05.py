...
locs = ['Petropolis - RJ', 'Brasilia - DF', 'Salvador - BA','Cachoeira Paulista - SP', 'Belo Horizonte - MG']
...
xtime = df.index.to_pydatetime() ## Variável criada para converter DatetimeIndex do Pandas para formato numérico interpretado pelo matplotlib.
...
ax.set_title(f"Previsão de 84h (Inicio: { inicio.strftime('%HUTC %d%b%Y') })", loc='right')
